...
router
  ...
  .get(
    authenticateJWT(["Admin", "Teacher"]),
    async (req: Request, res: Response) => {
      await studentController.fetchByLevel(req, res);
    }
  );
router
  .route("/by-class")
  .get(
    authenticateJWT(["Admin", "Teacher"]),
    async (req: Request, res: Response) => {
      await studentController.fetchStudentsByClass(req, res);
    }
  );
...
router
  ...
  .get(
    authenticateJWT(["Admin", "Teacher", "Student"]),
    async (req: Request, res: Response) => {
...
router.route("/cce/:id").get(async (req: Request, res: Response) => {
  await studentController.fetchCCEMark(req, res);
});
router.get(
  "/profile/:id",
  authenticateJWT(["Admin", "Teacher", "Student"]),
